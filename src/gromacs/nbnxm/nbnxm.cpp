...
void nonbonded_verlet_t::setAtomProperties(const t_mdatoms          &mdatoms,
                                           ...
                                           bool                      bFMM)
{
    nbnxn_atomdata_set(nbat.get(), pairSearch_->gridSet(), &mdatoms, atomInfo.data(), bFMM);
}
...
void nonbonded_verlet_t::init_f_on_gpu(rvec *f, const Nbnxm::AtomLocality locality)
{
    nbnxn_init_f_on_gpu(locality,
                        pairSearch_->gridSet(),
                        gpu_nbv,
                        f);
}
