...
const REAL **x_site2 = new const REAL *[1];
const REAL **y_site2 = new const REAL *[1];
const REAL **z_site2 = new const REAL *[1];
const REAL **q_site2 = new const REAL *[1];
