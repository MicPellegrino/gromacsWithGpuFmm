...
//! Version string of the underlying FMM code in src/gromacs/fmm/fmsolvr, containing the date of the last commit and an abbreviated hash.
extern const char _fmsolvr_version_string[];
