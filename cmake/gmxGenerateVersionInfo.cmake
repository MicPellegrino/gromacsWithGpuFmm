...
##### <FMSOLVR> #####
set(FMSOLVR_PROJECT_SOURCE_DIR "${PROJECT_SOURCE_DIR}/src/gromacs/fmm/fmsolvr")

# extract the shortened hash (7 char)
execute_process(COMMAND ${GIT_EXECUTABLE} rev-parse --short HEAD
    WORKING_DIRECTORY ${FMSOLVR_PROJECT_SOURCE_DIR}
    OUTPUT_VARIABLE FMSOLVR_HEAD_HASH_SHORT
    ERROR_VARIABLE EXEC_ERR
    OUTPUT_STRIP_TRAILING_WHITESPACE
)
...
execute_process(COMMAND ${GIT_EXECUTABLE} diff-index --name-only HEAD
    WORKING_DIRECTORY ${FMSOLVR_PROJECT_SOURCE_DIR}
    OUTPUT_VARIABLE FMSOLVR_SRC_LOCAL_CHANGES
    ERROR_VARIABLE EXEC_ERR
    OUTPUT_STRIP_TRAILING_WHITESPACE
)
if(NOT "${FMSOLVR_SRC_LOCAL_CHANGES}" STREQUAL "")
	set(FMSOLVR_DIRTY_STR "-dirty")
endif()

# get the date of the HEAD commit
execute_process(COMMAND ${GIT_EXECUTABLE} rev-list -n1 "--pretty=format:%ci" HEAD
    WORKING_DIRECTORY ${FMSOLVR_PROJECT_SOURCE_DIR}
    OUTPUT_VARIABLE FMSOLVR_HEAD_DATE
    ERROR_VARIABLE EXEC_ERR
    OUTPUT_STRIP_TRAILING_WHITESPACE
)
string(REGEX REPLACE "\n| " ";" FMSOLVR_HEAD_DATE "${FMSOLVR_HEAD_DATE}")
list(GET FMSOLVR_HEAD_DATE 2 FMSOLVR_HEAD_DATE)
string(REGEX REPLACE "-" "" FMSOLVR_HEAD_DATE "${FMSOLVR_HEAD_DATE}")

# compile the version string suffix
set(FMSOLVR_VERSION_STRING "${FMSOLVR_HEAD_DATE}-${FMSOLVR_HEAD_HASH_SHORT}${FMSOLVR_DIRTY_STR}")
